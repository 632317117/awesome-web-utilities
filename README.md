...
| Tool | Description | Pricing |
|------|-------------|---------|
| [CampPowerCalc](https://camppowercalc.com/en/) | Electrical calculator for van life and off-grid camping. Calculates battery size, solar wattage, and daily Wh consumption based on real appliance data and physics formulas. Automatically handles inverter loss and safety redundancy. | **Free** |
| [RoomPaintCalc](https://roompaintcalc.com/en/) | Paint calculator that determines exact liters needed based on room dimensions. Automatically subtracts doors (~2 m² each) and windows (~1.4 m² each). Uses standard coverage of 10 m² per liter. | **Free** |
| [WorkroomCalc](https://workroomcalc.co.uk/) | Free Roman blind calculator for fabric, lining, rods, rings, and cord estimates from recess or exact measurements. No signup. | **Free** |
...
| [InvoiceFormly](https://invoiceformly.com/en/) | Free invoice generator — create professional, print-ready PDF invoices in seconds. No sign-up, no watermarks, no limits. Free version includes PDF download, invoice history (My Invoices), and guides. Pro adds cloud sync, sender profiles, client book, one-click duplicate, status tracking, and custom templates/fields. | **Freemium** — Free, or $9.90/month for Pro |
